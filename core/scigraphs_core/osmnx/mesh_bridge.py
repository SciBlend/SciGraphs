# Moves NetworkX node and edge attributes onto a Blender mesh. The awkward part
# is that one graph edge can cover several mesh edges, because a curved street
# carries intermediate vertices between its two intersections.
