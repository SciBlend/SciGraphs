...
provides geocoding and geometry helpers.

## Download OSM features

The feature source/type selector is shared with **City2Graph ▸ Data Import**, so
the same preset or custom tags drive both entry points.
