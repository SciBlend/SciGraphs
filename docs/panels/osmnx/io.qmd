...
1. Use **GraphML** for a lossless OSMnx round-trip.
2. **Export** to a GIS format for interoperability with other tools.
3. **Save to Cache** to reuse a downloaded network without re-querying OSM.
