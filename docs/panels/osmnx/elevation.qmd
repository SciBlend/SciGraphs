...
::: {.callout-important}
OpenTopography requires an API key set in add-on preferences; Mapbox/MapTiler
basemaps (below) require their own keys.
:::
...
| Control | Description |
| --- | --- |
| **Source** | Imagery source (OSM/ESRI tiles, **WMS**, Mapbox, MapTiler). |
