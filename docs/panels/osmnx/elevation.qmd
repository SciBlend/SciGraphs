...
terrain mesh, and drapes a basemap onto it. It powers the
...
For a worked example using **Avenida Naciones Unidas, La Paz** (2 km radius),
follow [Elevation, DEM & 3D terrain](../../tutorials/panels/osmnx/elevation.qmd).
To drape satellite, street or WMS imagery from the mapping APIs onto that
terrain, continue with
