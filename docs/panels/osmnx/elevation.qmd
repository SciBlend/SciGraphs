...
[urban-terrain tutorial](../../tutorials/03-urban-terrain.qmd).

## Typical workflow

1. Pick a **Source**, choose **Apply to Nodes/Terrain**, set scale/offset, and
   **Get Elevation Data**.
2. **Apply 3D Positions** and **Calculate Grades**.
3. Manage the **Terrain Object**, then **Fetch & Apply** a **Basemap**, and
   render via the [Visualization panel](../scigraphs/visualization.qmd).
