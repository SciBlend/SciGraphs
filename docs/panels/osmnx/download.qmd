...
The Download panel imports a street network from OpenStreetMap into Blender.
Every other panel in the OSMnx tab operates on the graph it creates.

## Step 1. Download method

The inputs change with the method.
