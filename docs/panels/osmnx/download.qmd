...
1. Pick a **method** and fill in its inputs.
2. Choose a **Network Type** (or a preset/advanced filter).
3. Set the **options** (Simplify is recommended for most analyses).
4. **Import from OSM**, then continue to
   [Graph Operations](graph-operations.qmd) to project the graph.
