...
The Graph Operations panel transforms the imported graph: projection to a metric
CRS, conversion between directed/undirected and GeoDataFrame representations,
simplification, consolidation, and truncation to an area.
...
[Clean up the graph](../../tutorials/panels/osmnx/graph-operations.qmd).
