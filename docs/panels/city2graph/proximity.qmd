...
they contain. Generation parameters live in the **Single-Layer**,
**Multi-Layer**, and **Group Nodes** subpanels, while **Advanced Settings** and
**Visualization** apply across them.
...
| **Delaunay** | Delaunay triangulation. | (none) |
...
| **Gabriel** | Gabriel graph (a subset of Delaunay). | (none) |
| **Relative Neighborhood** | Relative Neighborhood Graph (RNG). | (none) |
| **EMST** | Euclidean Minimum Spanning Tree. | (none) |
...
## Subpanel: Group Nodes (Polygon to Point) {#group}

Connects polygon zones to the points they contain (e.g. districts to buildings).
...
Duplicate handling, useful when OSM ways/relations were imported as many
vertices.
