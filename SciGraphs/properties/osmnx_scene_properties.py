...
OSMNX_SCENE_PROPERTIES = {
    ...
    'osmnx_basemap_source': EnumProperty(
        name="Basemap Source",
        description="Imagery style used to texture the terrain mesh",
        items=[
            ...
            ("", "OpenStreetMap (no key)", "OpenStreetMap-based tiles, no API key required"),
            ('OSM', "OSM Standard",
                "OpenStreetMap standard rendered map"),
            ('OPENTOPOMAP', "OpenTopoMap",
                "Topographic style with contour lines and hillshading"),
            ...
            ("", "Mapbox (token)", "Mapbox styles. Requires Mapbox token in addon preferences"),
            ('MAPBOX_SATELLITE', "Satellite",
                "Mapbox satellite imagery"),
            ('MAPBOX_SATELLITE_STREETS', "Satellite Streets",
                "Mapbox satellite with street labels overlaid"),
            ('MAPBOX_STREETS', "Streets",
                "Mapbox streets vector style rasterized"),
            ('MAPBOX_OUTDOORS', "Outdoors",
                "Mapbox outdoors style with terrain"),
            ('MAPBOX_LIGHT', "Light",
                "Mapbox minimal light style"),
            ('MAPBOX_DARK', "Dark",
                "Mapbox minimal dark style"),

            ("", "MapTiler (key)", "MapTiler styles. Requires MapTiler key in addon preferences"),
            ('MAPTILER_SATELLITE', "Satellite",
                "MapTiler satellite imagery"),
            ('MAPTILER_HYBRID', "Satellite Hybrid",
                "MapTiler satellite with labels"),
            ('MAPTILER_STREETS', "Streets",
                "MapTiler streets style"),
            ('MAPTILER_TOPO', "Topographic",
                "MapTiler topographic style"),
            ('MAPTILER_OUTDOOR', "Outdoor",
                "MapTiler outdoor style"),
            ('MAPTILER_BASIC', "Basic",
                "MapTiler basic minimal style"),
            ('MAPTILER_WINTER', "Winter",
                "MapTiler winter style"),
            ('MAPTILER_OCEAN', "Ocean",
                "MapTiler ocean style"),

            ("", "Stadia / Stamen (key)", "Stadia Maps styles. Requires Stadia key in addon preferences"),
            ('STADIA_ALIDADE_SMOOTH', "Alidade Smooth (Light)",
                "Stadia Alidade Smooth — clean light basemap"),
            ('STADIA_ALIDADE_SMOOTH_DARK', "Alidade Smooth Dark",
                "Stadia Alidade Smooth Dark"),
            ('STADIA_OUTDOORS', "Outdoors",
                "Stadia Outdoors style with terrain"),
            ('STADIA_STAMEN_TONER', "Stamen Toner (B/W)",
                "High-contrast black & white map"),
            ('STADIA_STAMEN_TERRAIN', "Stamen Terrain",
                "Terrain map with hillshading"),
            ('STADIA_STAMEN_WATERCOLOR', "Stamen Watercolor",
