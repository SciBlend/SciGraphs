"""Mesh and material wiring behind the coloring operators.

Nothing here touches ``bpy.context`` directly; callers pass in the context or
the already-resolved object.
"""
